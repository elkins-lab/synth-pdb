...
from synth_pdb.msa import MetropolisHastingsSampler, CoevolutionModel
...
def test_sampler_rejection_low_temp():
    ...
    assert final_energy <= initial_energy, "Low Temperature MCMC should never accept higher energy states."
