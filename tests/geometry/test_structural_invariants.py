...
def test_chirality_invariant() -> None:
    """
...
def test_nerf_cyclic_consistency() -> None:
    """
    ...
    # Ensure coordinates are float64 for high-precision math
    orig_coords = peptide.coord[:4].copy().astype(np.float64)
...
def test_ideal_bond_lengths() -> None:
    """
