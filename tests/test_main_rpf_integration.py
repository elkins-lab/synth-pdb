...
def test_main_rpf_validation_cli(tmp_path):
    """
    ...
    cmd = [
        sys.executable, "-m", "synth_pdb.main",
        "--sequence", "AKAAKAAK",
    ...
    # 3. Verify Output
    assert "--- NMR RPF Validation Report ---" in result.stdout or "--- NMR RPF Validation Report ---" in result.stderr
...
def test_main_rpf_validation_nef_cli(tmp_path):
    """
